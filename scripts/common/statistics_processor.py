...
class StatisticsProcessor():
    ...
    def populateMarketStatistics(self, config):
        ...
        self.push_df_to_aiven(self, "daily_stock_stats", df, self.avienUri)
        self.dbHelper.updateDailyStockStatsSummary(df)

    def push_df_to_aiven(self, table_name: str, df: pd.DataFrame, arienUri):
