...
async function insertDailyStockStats(dailyStockStat) {
  const result = await sql`
    ...
    ${dailyStockStat.roc125sctr}, ${dailyStockStat.sctr1}, ${dailyStockStat.sctr2}, ${dailyStockStat.sctr3}, ${dailyStockStat.sctr4}, 
    ...
    ${dailyStockStat.sctr20}, ${dailyStockStat.histDay}, ${dailyStockStat.chg_pct_1d}, 
